...
The tunable hyper-parameters for the the Naive Bayes classifier is a $\lambda$ -value used for additive smoothing.  
The parameter space for $\lambda$ is chosen \textbf{from 0.1 to 10.0} (inclusive).  \\
...
\end{tikzpicture}
\\
The best performing naive bayes classifier reaches a maximal f\textsubscript{2}-score of \textbf{  } (precision:  , recall: ) with the hyper-parameter:\\
$\lambda$ :  \qquad \textbf{  }\\
